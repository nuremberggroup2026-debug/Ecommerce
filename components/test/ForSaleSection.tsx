        ...
        <header className="mb-14 flex items-end justify-between">
          <div className="space-y-2 text-center sm:text-left">
            <div className="inline-flex items-center gap-2">
              ...
              <span className="text-xs font-semibold uppercase tracking-widest text-red-500">Limited Offers</span>
            </div>
            ...
            return (
              <div key={product.id} className="group relative flex flex-col space-y-4">
                ...
                <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl border border-neutral-200/60 bg-neutral-100 shadow-sm">
                  ...
                  {/* شارة الخصم الفخمة باللون الأحمر الخافت */}
