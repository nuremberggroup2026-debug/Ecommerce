export const categoriesListTheme = {
  ...
  card: "group relative overflow-hidden rounded-full aspect-square border border-[#a3e635]/15 shadow-sm transition-all duration-500 hover:shadow-xl",
  ...
  cardTitle: "font-sans text-2xl text-[#ffffff]",
  exploreLink: (isAr: boolean) =>
    `mt-2 flex items-center gap-2 text-sm text-[#d9f99d]/90 opacity-0 transition-all duration-500 group-hover:opacity-100 ${
