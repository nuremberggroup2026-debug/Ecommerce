export const categoriesListTheme = {
  ...
  card: "group relative overflow-hidden rounded-lg aspect-square border border-[#2563eb]/15 shadow-sm transition-all duration-500 hover:shadow-xl",
  ...
  exploreLink: (isAr: boolean) =>
    `mt-2 flex items-center gap-2 text-sm text-[#93c5fd]/90 opacity-0 transition-all duration-500 group-hover:opacity-100 ${
