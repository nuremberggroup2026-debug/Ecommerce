export const navbarTheme = {
  ...
  logo: "text-lg font-semibold tracking-tight text-neutral-900 active:scale-[0.98] transition-transform",

  logoAccent: "font-light text-neutral-400",

  desktopLinks: "hidden items-center gap-8 md:flex",

  desktopItem: "relative flex flex-col items-center",

  link: "text-xs  tracking-widest transition-all duration-300 pb-1 font-medium active:scale-95 block",

  linkActive: "text-black font-semibold scale-105",

  linkInactive: "text-neutral-400 hover:text-black",
  ...
  iconActive: "text-black bg-neutral-50",

  iconInactive: "text-neutral-500 hover:text-black hover:bg-neutral-50",
  ...
  mobileLinkActive: "text-black font-semibold",
