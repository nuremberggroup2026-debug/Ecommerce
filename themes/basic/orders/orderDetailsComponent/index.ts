export const orderDetailsComponentTheme = {
  main: "min-h-screen bg-neutral-50/50 pb-20 text-neutral-900",
  container: "mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12",
  header: "mb-10 flex flex-col gap-4 border-b border-neutral-100 pb-8",
  backLink: "inline-flex w-fit items-center gap-2 text-xs font-semibold uppercase tracking-wider text-neutral-500 transition-colors hover:text-neutral-900",
  ...
  orderTitle: "text-xl font-bold tracking-tight text-neutral-900 wrap-break-word sm:text-2xl md:text-3xl",
  statusBadge: (statusClass: string) =>
    `rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-wider ${statusClass}`,
