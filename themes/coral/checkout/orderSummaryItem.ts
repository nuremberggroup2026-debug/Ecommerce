export const orderSummaryItemTheme = {
  ...
  infoCol: "min-w-0",
  title: "truncate text-sm font-medium text-[#0a2e2a]",
  sku: "mt-1 text-xs text-teal-400",
  subtotal: "shrink-0 text-sm font-semibold text-[#0a2e2a]",
  attributesWrapper: "mt-2 flex flex-wrap gap-x-3 gap-y-1",
  attributeSpan: "text-xs text-teal-400",
  footerRow: "mt-3 flex items-center justify-between",
  quantityText: "text-xs text-teal-400",
  unitPriceText: "text-xs text-teal-400",
};
