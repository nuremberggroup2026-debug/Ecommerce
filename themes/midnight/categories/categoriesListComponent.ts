export const categoriesListTheme = {
  main: "bg-[#17121f] text-[#f5f2fb]",
  heroSection: "mx-auto max-w-7xl px-6 py-24 lg:px-10",
  heroContent: "max-w-3xl",
  title: "font-mono text-5xl tracking-tight md:text-6xl",
  description: "mt-6 text-lg leading-relaxed text-violet-400",
  gridSection: "mx-auto max-w-7xl px-6 pb-24 lg:px-10",
  grid: "grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4",
  card: "group relative overflow-hidden rounded-none aspect-square border border-[#a78bfa]/15 shadow-sm transition-all duration-500 hover:shadow-xl",
  ...
  cardTitle: "font-mono text-2xl text-[#17121f]",
  exploreLink: (isAr: boolean) =>
    `mt-2 flex items-center gap-2 text-sm text-[#3d2b5c]/90 opacity-0 transition-all duration-500 group-hover:opacity-100 ${
