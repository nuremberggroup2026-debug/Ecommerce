...
import type { ProductByLocale } from "@/features/products/types/index";
import { useProductByIdQuery } from "@/features/products/hooks/useProductById";
...
export default function ProductSection({
  ...
  const { data: product, isLoading, isError } = useProductByIdQuery(locale, id);
  ...
  const handleVariantChange = (
    ...
    setActiveImage(
      variant.variantImage ?? product.productData.productCardImage,
    );
  };
